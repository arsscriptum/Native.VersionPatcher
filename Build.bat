...
:init
    ...
    set "__build_cfg=%__script_path%build.ini"
...
:: ==============================================================================
:clean
    call %__lib_out% :__out_l_red " CLEANING DEBUG"  
    call %__makefile% /v /i %__build_cfg% /t Clean /c Debug /p x86
    call %__lib_out% :__out_l_red " CLEANING RELEASE"  
...
:build
    call :call_make_build %__target_configuration% %__target_platform%
    goto :eof
